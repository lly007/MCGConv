...
def main(args):
    ...
    testDataLoader = torch.utils.data.DataLoader(test_dataset, batch_size=args.batch_size, shuffle=False, num_workers=10, pin_memory=True)
    ...
    for epoch in range(start_epoch, args.epoch):
        log_string('Epoch %d (%d/%s), Learning Rate %f:' % (global_epoch + 1, epoch + 1, args.epoch, optimizer.state_dict()['param_groups'][0]['lr']))
        mean_correct = []
